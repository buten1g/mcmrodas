...
return [
    ...
    */
    ...
    'max' => [
        'numeric' => 'Este valor não pode ser superior a :max.',
        'file'    => 'Este valor não pode ser superior a :max kilobytes.',
        'string'  => 'Este valor não pode ser superior a :max caracteres.',
        'array'   => 'Este valor não pode ter mais do que :max itens.',
    ],
